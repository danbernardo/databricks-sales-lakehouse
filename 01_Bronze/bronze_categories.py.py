...
# DBTITLE 1,Ingestão Bronze - Categories
from pyspark.sql.functions import current_timestamp, lit, input_file_name

# 1. Leitura do CSV bruto do volume
caminho_arquivo = "/Volumes/main/bronze/sales_data/categories.csv"
...
bronze_df = df \
    ...
    .withColumn("file_name", lit("categories.csv"))

# 3. Salvamento como tabela Delta na camada Bronze
bronze_df.write.format("delta").mode("overwrite").saveAsTable("main.bronze.categories")
