...
caminho_arquivo = "/Volumes/main/bronze/sales_data/shippers.csv"
...
bronze_df = df \
    ...
    .withColumn("file_name", lit("shippers.csv"))

# 3. Salvamento como tabela Delta na camada Bronze
bronze_df.write.format("delta").mode("overwrite").saveAsTable("main.bronze.shippers")
