...
caminho_arquivo = "/Volumes/main/bronze/sales_data/orderdetails.csv"
...
bronze_df = df \
    ...
    .withColumn("file_name", lit("orderdetails.csv"))

# 3. Salvamento como tabela Delta na camada Bronze
bronze_df.write.format("delta").mode("overwrite").saveAsTable("main.bronze.orderdetails")
