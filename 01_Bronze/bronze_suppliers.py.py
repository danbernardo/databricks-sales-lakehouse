...
# DBTITLE 1,Ingestão Bronze - Suppliers
from pyspark.sql.functions import current_timestamp, lit, input_file_name

# 1. Leitura do CSV bruto do volume
caminho_arquivo = "/Volumes/main/bronze/sales_data/suppliers.csv"
...
bronze_df = df \
    ...
    .withColumn("file_name", lit("suppliers.csv"))

# 3. Salvamento como tabela Delta na camada Bronze
bronze_df.write.format("delta").mode("overwrite").saveAsTable("main.bronze.suppliers")
